...
describe("summary inputs", () => {
  const inputs: SummaryInputs = {
    ...
    recalls: [{ id: "r", agency: "FSIS", url: "https://fsis/r", sourceRecordUrl: null, title: "Acme recalls beef", firm: "Acme", product: "Ground beef", products: ["Ground beef"], productCount: 1, category: "human-food", foodKeys: ["beef"], reason: "E. coli", reasonCategory: "ecoli", classification: "Class I", status: "Active Recall", states: ["TX"], distributionPattern: null, relatedToOutbreak: false, recallDate: "2026-09-12", reportDate: "2026-09-12", initiatedBy: null, notificationMethod: null, summary: null, closedDate: null, closedYear: null, agencyUpdatedAt: null, processing: null, firmLocation: null, fetchedAt: "t" }],
  };
